...
2.  In your development tool of choice, do a **global** find-and-replace:
	+   Replace all instances of the "casasoft\complexmanager" namespace to reflect your organization
	+   Replace all instances of "ComplexManager" to your class name.
	+   Replace all instances of "complexmanager" with your plugin's slug -- this will replace things like the
...
add_action( 'complexmanager_init', array( 'casasoft\complexmanager\LoginBranding', 'init' ) );
```

Again, you'd need to replace "casasoft\complexmanager" namespace at the top and bottom of the document,
as well as changing 'complexmanager_init' to use your slug instead of "complexmanager".
...
// Subscribe to the drop-in to the initialization event
add_action( 'complexmanager_init', array( 'casasoft\complexmanager\BasicMath', 'init' ) );
```
